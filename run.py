...
if __name__ == '__main__':
    ...
    optional.add_argument('--n_iter', default=DEFAULT_RUN_PARAMS['n_iter'], type=float,
                          help='number of algorithm iterations (generations)')
    optional.add_argument('--n_seconds', default=DEFAULT_RUN_PARAMS['n_seconds'], type=float,
